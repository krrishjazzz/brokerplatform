...
export function HomeHeroSection() {
  return (
    <section className="relative min-h-[520px] border-b border-border lg:min-h-[580px]">
      ...
      <div className="relative z-10 mx-auto max-w-7xl overflow-visible px-4 py-10 lg:px-6 lg:py-14">
        <div className="grid gap-8 lg:grid-cols-12 lg:items-start lg:gap-10">
          ...
          <div className="relative z-20 w-full overflow-visible lg:col-span-7 lg:mt-4 xl:col-span-8">
            <SmartSearchPanel variant="hero" className="w-full" />
          </div>
        </div>
      </div>
    </section>
